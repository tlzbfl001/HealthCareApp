...
class DataManager(private var context: Context?) {
   ...
   fun getUser() : User {
      ...
      while(cursor.moveToNext()) {
         ...
         values.profileImage = cursor.getString(10)
   ...
   fun getUserUpdated() : User {
      val db = dbHelper!!.readableDatabase
      val values = User()
      val sql = "select id, name, gender, birthday, profileImage, height, weight from $USER where id = ${MyApp.prefs.getUserId()} and $IS_UPDATED = 1"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         values.id=cursor.getInt(0)
         ...
         values.profileImage = cursor.getString(4)
   ...
   fun getData(table: String, column: String, data: String) : FoodInit {
      val db = dbHelper!!.readableDatabase
      val values = FoodInit()
   ...
   fun getFood(column: String, data: Int) : FoodInit {
      val db = dbHelper!!.readableDatabase
      val values = FoodInit()
   ...
   fun getFood(column: String, data: String) : FoodInit {
      val db = dbHelper!!.readableDatabase
      val values = FoodInit()
      val sql = "select * from $FOOD where $USER_ID = ${MyApp.prefs.getUserId()} and $column = '$data'"
      val cursor = db!!.rawQuery(sql, null)
   ...
   fun getFoodUid() : ArrayList<FoodInit> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<FoodInit>()
      val sql = "select * from $FOOD where $USER_ID = ${MyApp.prefs.getUserId()} and uid is '' limit 5"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = FoodInit()
         values.id=cursor.getInt(0)
   ...
   fun getFoodUpdated() : ArrayList<FoodInit> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<FoodInit>()
      val sql = "select * from $FOOD where $USER_ID = ${MyApp.prefs.getUserId()} and $IS_UPDATED = 1 and uid <> '' limit 5"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = FoodInit()
         values.id=cursor.getInt(0)
   ...
   fun getSearchFood(column: String) : ArrayList<FoodInit> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<FoodInit>()
   ...
   fun getDailyFood(column: String, id: Int) : FoodInit {
      val db = dbHelper!!.readableDatabase
      val values = FoodInit()
   ...
   fun getDailyFood(type: String, date: String) : ArrayList<FoodInit> {
      val db = dbHelper!!.readableDatabase
      val list: ArrayList<FoodInit> = ArrayList()
   ...
   fun getDailyFood(type: String, name: String, date: String) : FoodInit {
      val db = dbHelper!!.readableDatabase
      val values = FoodInit()
   ...
   fun getDailyFoodUid() : ArrayList<FoodInit> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<FoodInit>()
      val sql = "select * from $DAILY_FOOD where $USER_ID = ${MyApp.prefs.getUserId()} and uid is '' limit 5"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = FoodInit()
         values.id=cursor.getInt(0)
   ...
   fun getDailyFoodUpdated() : ArrayList<FoodInit> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<FoodInit>()
      val sql = "select * from $DAILY_FOOD where $USER_ID = ${MyApp.prefs.getUserId()} and $IS_UPDATED = 1 and uid <> '' limit 5"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = FoodInit()
         values.id=cursor.getInt(0)
   ...
   fun getWater(date: String) : InitWater {
      val db = dbHelper!!.readableDatabase
      val values = InitWater()
   ...
   fun getWaterUid() : ArrayList<InitWater> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<InitWater>()
      val sql = "select * from $WATER where $USER_ID = ${MyApp.prefs.getUserId()} and uid is '' limit 5"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = InitWater()
         values.id = cursor.getInt(0)
   ...
   fun getWaterUpdated() : ArrayList<InitWater> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<InitWater>()
      val sql = "select * from $WATER where $USER_ID = ${MyApp.prefs.getUserId()} and $IS_UPDATED = 1 and uid <> '' limit 5"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = InitWater()
         values.id = cursor.getInt(0)
   ...
   fun getExercise(id: Int): InitExercise {
      val db = dbHelper!!.readableDatabase
      val values = InitExercise()
   ...
   fun getExercise(column: String, data: String) : InitExercise {
      val db = dbHelper!!.readableDatabase
      val values = InitExercise()
   ...
   fun getExerciseUid(): ArrayList<InitExercise> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<InitExercise>()
      val sql = "select * from $EXERCISE where $USER_ID = ${MyApp.prefs.getUserId()} and uid is '' limit 5"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = InitExercise()
         values.id = cursor.getInt(0)
   ...
   fun getExerciseUpdated(): ArrayList<InitExercise> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<InitExercise>()
      val sql = "select * from $EXERCISE where $USER_ID = ${MyApp.prefs.getUserId()} and $IS_UPDATED = 1 and uid <> '' limit 5"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = InitExercise()
         values.id = cursor.getInt(0)
   ...
   fun getDailyExercise(column: String, id: Int): InitExercise {
      val db = dbHelper!!.readableDatabase
      val values = InitExercise()
   ...
   fun getDailyExercise(column: String, data: String): ArrayList<InitExercise> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<InitExercise>()
   ...
   fun getDailyExerciseUid(): ArrayList<InitExercise> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<InitExercise>()
      val sql = "select * from $DAILY_EXERCISE where $USER_ID = ${MyApp.prefs.getUserId()} and uid is '' limit 5"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = InitExercise()
         values.id = cursor.getInt(0)
   ...
   fun getDailyExerciseUpdated(): ArrayList<InitExercise> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<InitExercise>()
      val sql = "select * from $DAILY_EXERCISE where $USER_ID = ${MyApp.prefs.getUserId()} and $IS_UPDATED = 1 and uid <> '' limit 5"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = InitExercise()
         values.id = cursor.getInt(0)
   ...
   fun getSearchExercise(column: String) : ArrayList<InitExercise> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<InitExercise>()
   ...
   fun getBody(date: String) : InitBody {
      val db = dbHelper!!.readableDatabase
      val values = InitBody()
   ...
   fun getBody(start: String, end: String) : ArrayList<InitBody> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<InitBody>()
   ...
   fun getBodyUid() : ArrayList<InitBody> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<InitBody>()
      val sql = "select * from $BODY where $USER_ID = ${MyApp.prefs.getUserId()} and uid is '' limit 5"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = InitBody()
         values.id = cursor.getInt(0)
   ...
   fun getBodyUpdated() : ArrayList<InitBody> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<InitBody>()
      val sql = "select * from $BODY where $USER_ID = ${MyApp.prefs.getUserId()} and $IS_UPDATED = 1 and uid <> '' limit 5"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = InitBody()
         values.id = cursor.getInt(0)
   ...
   fun getSleep(date: String) : InitSleep {
      val db = dbHelper!!.readableDatabase
      val values = InitSleep()
   ...
   fun getSleepUid() : ArrayList<InitSleep> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<InitSleep>()
      val sql = "select id, startTime, endTime from $SLEEP where $USER_ID = ${MyApp.prefs.getUserId()} and uid is '' limit 5"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = InitSleep()
         values.id = cursor.getInt(0)
   ...
   fun getSleepUpdated() : ArrayList<InitSleep> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<InitSleep>()
      val sql = "select id, uid, startTime, endTime from $SLEEP where $USER_ID = ${MyApp.prefs.getUserId()} and $IS_UPDATED = 1 and uid <> '' limit 5"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = InitSleep()
         values.id = cursor.getInt(0)
   ...
   fun getDrugDate(data: String) : ArrayList<Int> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<Int>()
      val sql = "select id from $DRUG where $USER_ID=${MyApp.prefs.getUserId()} and startDate >= '$data'"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
   ...
   fun getDrugData(data: Int) : Drug {
      val db = dbHelper!!.readableDatabase
      val values = Drug()
      val sql = "select name, amount, unit, startDate, endDate, isSet from $DRUG where $USER_ID=${MyApp.prefs.getUserId()} and id=$data"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         values.name = cursor.getString(0)
         values.amount = cursor.getInt(1)
         values.unit = cursor.getString(2)
         values.startDate = cursor.getString(3)
         values.endDate = cursor.getString(4)
   ...
   fun getDrugUid() : ArrayList<Drug> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<Drug>()
      val sql = "select * from $DRUG where $USER_ID = ${MyApp.prefs.getUserId()} and uid is '' limit 5"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = Drug()
         values.id = cursor.getInt(0)
   ...
   fun getDrugUpdated() : ArrayList<Drug> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<Drug>()
      val sql = "select * from $DRUG where $USER_ID = ${MyApp.prefs.getUserId()} and $IS_UPDATED = 1 and uid <> '' limit 5"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = Drug()
         values.id = cursor.getInt(0)
   ...
   fun getDrugTime(data: Int) : ArrayList<DrugTime> {
      ...
      val sql = "select id, uid, time from $MEDICINE_TIME where $USER_ID = ${MyApp.prefs.getUserId()} and drugId = $data order by time"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = DrugTime()
         values.id = cursor.getInt(0)
   ...
   fun getDrugTimeData(data: Int) : ArrayList<DrugTime> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<DrugTime>()
      val sql = "select id, time from $MEDICINE_TIME where $USER_ID = ${MyApp.prefs.getUserId()} and uid is '' and drugId = $data"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = DrugTime()
         values.id = cursor.getInt(0)
   ...
   fun getDrugCheckUid() : ArrayList<DrugCheck> {
      ...
      val sql = "select id, drugId, drugTimeId, time from $DRUG_CHECK where $USER_ID = ${MyApp.prefs.getUserId()} and uid is '' limit 5"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = DrugCheck()
         values.id = cursor.getInt(0)
         values.drugId = cursor.getInt(1)
         values.drugTimeId = cursor.getInt(2)
         values.time = cursor.getString(3)
         list.add(values)
      }
      cursor.close()
      return list
   ...
   fun getGoal(date: String) : GoalInit {
      val db = dbHelper!!.readableDatabase
      val values = GoalInit()
   ...
   fun getGoalUid() : ArrayList<GoalInit> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<GoalInit>()
      val sql = "select * from $GOAL where $USER_ID = ${MyApp.prefs.getUserId()} and uid is '' limit 5"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = GoalInit()
         values.id = cursor.getInt(0)
   ...
   fun getGoalUpdated() : ArrayList<GoalInit> {
      val db = dbHelper!!.readableDatabase
      val list = ArrayList<GoalInit>()
      val sql = "select * from $GOAL where $USER_ID = ${MyApp.prefs.getUserId()} and $IS_UPDATED = 1 and uid <> '' limit 5"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = GoalInit()
         values.id = cursor.getInt(0)
   ...
   fun getUnused() : ArrayList<Unused> {
      ...
      val sql = "select * from $UNUSED where $USER_ID = ${MyApp.prefs.getUserId()} limit 20"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = Unused()
         values.id = cursor.getInt(0)
   ...
   fun getUnusedTime(data: String) : ArrayList<Unused> {
      val db = dbHelper!!.readableDatabase
      val list: ArrayList<Unused> = ArrayList()
      val sql = "select id, type, value, $CREATED_AT from $UNUSED where $USER_ID = ${MyApp.prefs.getUserId()} and drugUid = '$data'"
      val cursor = db!!.rawQuery(sql, null)
      while(cursor.moveToNext()) {
         val values = Unused()
         values.id = cursor.getInt(0)
         values.type = cursor.getString(1)
         values.value = cursor.getString(2)
         values.createdAt = cursor.getString(3)
         list.add(values)
      }
      cursor.close()
   ...
   fun insertFoods() {
      ...
      val values = ContentValues()
      values.put("name", "q2")
      values.put("calorie", 22)
      values.put("carbohydrate", 2.2)
      values.put("protein", 1.1)
      values.put("fat", 1.1)
      values.put("quantity", 1)
      values.put("quantity_unit", "개")
      values.put("volume", 1)
      values.put("volume_unit", "g")
      values.put("register_type", "USER")
      values.put("created_at", "2024-11-02 15:51:25.112")
      values.put("updated_at", "2024-11-02 15:51:25.112")
      values.put("deleted_at", "")
      values.put("user_id", getUser().uid)
      db!!.insert("foods", null, values)
   }

   fun insertDailyFood(data: FoodInit) {
      val db = dbHelper!!.writableDatabase
      val values = ContentValues()
      values.put(USER_ID, MyApp.prefs.getUserId())
      values.put("uid", data.uid)
   ...
   fun insertWater(data: InitWater) {
      val db = dbHelper!!.writableDatabase
      val values = ContentValues()
      values.put(USER_ID, MyApp.prefs.getUserId())
      values.put("uid", data.uid)
   ...
   fun insertExercise(data: InitExercise) {
      val db = dbHelper!!.writableDatabase
      val values = ContentValues()
      values.put(USER_ID, MyApp.prefs.getUserId())
      values.put("registerType", data.registerType)
   ...
   fun insertDailyExercise(data: InitExercise) {
      val db = dbHelper!!.writableDatabase
      val values = ContentValues()
      values.put(USER_ID, MyApp.prefs.getUserId())
      values.put("uid", data.uid)
   ...
   fun insertSleep(data: InitSleep) {
      val db = dbHelper!!.writableDatabase
      val values = ContentValues()
      values.put(USER_ID, MyApp.prefs.getUserId())
      values.put("uid", data.uid)
   ...
   fun updateUser2(data: User){
      val db = dbHelper!!.writableDatabase
      val sql = "update $USER set idToken='${data.idToken}', accessToken='${data.accessToken}', deviceUid='${data.deviceUid}', name='${data.name}', gender='${data.gender}', " +
         "birthday='${data.birthday}', image='${data.profileImage}', height='${data.height}', weight='${data.weight}' where type='${data.type}' and email='${data.email}'"
      db.execSQL(sql)
      db.close()
   }
   ...
   fun updateDailyFood(data: FoodInit){
      val db = dbHelper!!.writableDatabase
   ...
   fun updateDailyExercise(data: InitExercise){
      val db = dbHelper!!.writableDatabase
   ...
   fun updateSleep(data: InitSleep){
      val db = dbHelper!!.writableDatabase
