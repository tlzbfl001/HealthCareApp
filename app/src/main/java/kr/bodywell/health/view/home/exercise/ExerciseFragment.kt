...
import kr.bodywell.health.adapter.ExerciseAdapter
import kr.bodywell.health.databinding.FragmentExerciseBinding
...
import kr.bodywell.health.util.CustomUtil.getExerciseCalories
...
class ExerciseFragment : Fragment() {
   ...
   override fun onCreateView(
      ...
      btnSave.setOnClickListener {
         if(et.text.toString().trim() == "") {
            ...
            binding.progressbar.max = et.text.toString().toInt()
   ...
   private fun dailyView() {
      ...
      lifecycleScope.launch {
         ...
         if(getGoal.kcalOfWorkout > 0) binding.progressbar.max = getGoal.kcalOfWorkout else binding.progressbar.max = sum
