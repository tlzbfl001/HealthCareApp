...
import kr.bodywell.health.adapter.MedicineAdapter4
import kr.bodywell.health.databinding.FragmentMedicineAddBinding
...
import kr.bodywell.health.util.CustomUtil.setDrugTimeList
...
class MedicineAddFragment : Fragment() {
            ...
            lifecycleScope.launch {
               if(getMedicine != null) { // 약복용 정보 수정
                  ...
                  dataManager.updateMedicine(MedicineItem(id = getData.id, name = name, amount = amount, unit = unit,
                     starts = getMedicine.starts, ends = ends))
   ...
   private fun unit1() {
      binding.tvUnit1.background = resources.getDrawable(R.drawable.rec_40_purple)
   ...
   private fun unit2() {
      ...
      binding.tvUnit2.background = resources.getDrawable(R.drawable.rec_40_purple)
   ...
   private fun unit3() {
      ...
      binding.tvUnit2.background = resources.getDrawable(R.drawable.rec_25_border_gray)
      binding.tvUnit2.setTextColor(Color.BLACK)
      binding.tvUnit3.background = resources.getDrawable(R.drawable.rec_40_purple)
   ...
   private fun unit4() {
      ...
      binding.tvUnit3.background = resources.getDrawable(R.drawable.rec_25_border_gray)
      binding.tvUnit3.setTextColor(Color.BLACK)
      binding.tvUnit4.background = resources.getDrawable(R.drawable.rec_40_purple)
   ...
   private fun unit5() {
      ...
      binding.tvUnit4.background = resources.getDrawable(R.drawable.rec_25_border_gray)
      binding.tvUnit4.setTextColor(Color.BLACK)
      binding.tvUnit5.background = resources.getDrawable(R.drawable.rec_40_purple)
   ...
   private fun unit6() {
      ...
      binding.tvUnit5.background = resources.getDrawable(R.drawable.rec_25_border_gray)
      binding.tvUnit5.setTextColor(Color.BLACK)
      binding.tvUnit6.background = resources.getDrawable(R.drawable.rec_40_purple)
