...
import kr.bodywell.health.adapter.MedicineAdapter1
import kr.bodywell.health.databinding.FragmentMedicineBinding
...
import kr.bodywell.health.util.PermissionUtil.checkAlarmPermission1
import kr.bodywell.health.util.PermissionUtil.checkAlarmPermission2
import kr.bodywell.health.view.MainViewModel
import kr.bodywell.health.view.setting.AlarmFragment
...
class MedicineFragment : Fragment() {
   ...
   override fun onCreateView(
      ...
      viewModel.medicineCheckState.observe(viewLifecycleOwner, Observer<Int> { item ->
         if(getGoal.medicineIntake > 0) binding.progressbar.max = getGoal.medicineIntake else binding.progressbar.max = item
         binding.progressbar.progress = item
   ...
   private fun dailyView() {
      ...
      lifecycleScope.launch {
         ...
         if(getGoal.medicineIntake > 0) binding.progressbar.max = getGoal.medicineIntake else binding.progressbar.max = getRecently.size
         binding.progressbar.progress = getRecently.size
