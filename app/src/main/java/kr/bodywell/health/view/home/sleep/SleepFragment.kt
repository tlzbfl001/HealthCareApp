...
import kr.bodywell.health.databinding.FragmentSleepBinding
...
import kr.bodywell.health.util.CustomUtil.isoToDateTime
   ...
   private fun dailyView() {
      ...
      lifecycleScope.launch {
         ...
         if(getSleep.starts != "" && getSleep.ends!= "") {
            ...
            val diff = Duration.between(starts, ends)
         ...
         if(getGoal.sleep > 0) binding.progressbar.max = getGoal.sleep else binding.progressbar.max = total
