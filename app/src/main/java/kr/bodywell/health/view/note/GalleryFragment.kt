...
import kr.bodywell.health.adapter.GalleryAdapter
import kr.bodywell.health.databinding.FragmentGalleryBinding
...
class GalleryFragment : Fragment() {
	...
	private fun showButtonUI1() {
		...
		viewModel.setItemSelectState(false)
		selectionList.clear()
	...
	private fun showButtonUI2() {
		...
		viewModel.setItemSelectState(true)
	}
