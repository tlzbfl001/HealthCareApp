...
import kr.bodywell.test.util.BluetoothService
import kr.bodywell.test.util.BluetoothService.Companion.btStatus
import kr.bodywell.test.util.BluetoothService.Companion.deviceNum
