...
import kr.bodywell.test.database.DBHelper.Companion.TYPE_ADMIN
...
import kr.bodywell.test.view.init.InputActivity
import kr.bodywell.test.view.init.LoginActivity
import kr.bodywell.test.view.init.SignupActivity
