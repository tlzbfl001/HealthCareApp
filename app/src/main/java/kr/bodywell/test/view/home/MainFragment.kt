...
import kr.bodywell.test.adapter.CalendarAdapter1
import kr.bodywell.test.database.DataManager
import kr.bodywell.test.databinding.FragmentMainBinding
...
import kr.bodywell.test.util.CustomUtil.Companion.dataType
import kr.bodywell.test.util.CustomUtil.Companion.getExerciseCalories
