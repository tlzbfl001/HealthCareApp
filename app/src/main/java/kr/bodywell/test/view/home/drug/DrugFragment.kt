...
import kr.bodywell.test.adapter.DrugAdapter1
...
import kr.bodywell.test.databinding.FragmentDrugBinding
import kr.bodywell.test.model.Goal
import kr.bodywell.test.model.DrugList
import kr.bodywell.test.util.CalendarUtil.selectedDate
import kr.bodywell.test.util.CustomUtil.replaceFragment1
import kr.bodywell.test.util.PermissionUtil.checkAlarmPermission1
import kr.bodywell.test.util.PermissionUtil.checkAlarmPermission2
import kr.bodywell.test.view.MainViewModel
import kr.bodywell.test.view.setting.AlarmFragment
