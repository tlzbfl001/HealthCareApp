package kr.bodywell.test.view.report
...
import kr.bodywell.test.databinding.FragmentReportFoodBinding
import kr.bodywell.test.model.Water
import kr.bodywell.test.util.CalendarUtil.Companion.dateFormat
import kr.bodywell.test.util.CalendarUtil.Companion.monthArray2
import kr.bodywell.test.util.CalendarUtil.Companion.monthFormat
import kr.bodywell.test.util.CalendarUtil.Companion.selectedDate
import kr.bodywell.test.util.CalendarUtil.Companion.weekArray
import kr.bodywell.test.util.CalendarUtil.Companion.weekFormat
import kr.bodywell.test.util.CustomUtil.Companion.getFoodCalories
import kr.bodywell.test.util.CustomUtil.Companion.getNutrition
