...
import kr.bodywell.test.adapter.BtListAdapter
import kr.bodywell.test.databinding.FragmentConnectBinding
import kr.bodywell.test.model.Bluetooth
import kr.bodywell.test.util.PermissionUtil.Companion.BT_PERMISSION_1
import kr.bodywell.test.util.PermissionUtil.Companion.BT_PERMISSION_2
import kr.bodywell.test.util.PermissionUtil.Companion.REQUEST_CODE
